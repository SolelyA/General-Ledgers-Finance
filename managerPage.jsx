...
import bellIconNew from "../Images/bellIconNewNotif.png"
...
const ManagerPage = () => {
    ...
    return (
        <div>
            ...
            />
            <button onClick={() => setButtonPopup(true)} className="custom-button">{readNotif ?(
                        <img src={bellIconNew} alt="Custom Button" />
                    ): (
                        <div>
                        <img src={bellIcon} alt="Custom Button" />
                        </div>
                    )}
            </button>
